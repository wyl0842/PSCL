import numpy as np
from utils import utils_data as utils
import os
import numpy as np
import torch
import torchvision
...
def dataset_split(train_images, train_labels, dataset='mnist', noise_type='symmetric', noise_rate=0.5, split_per=0.9, random_seed=1, num_classes=10):
    ...
    ori_clean_train_labels, ori_clean_val_labels = train_labels_cp[train_set_index], train_labels_cp[val_set_index]

    return train_set, val_set, train_labels, val_labels, ori_clean_train_labels, ori_clean_val_labels
