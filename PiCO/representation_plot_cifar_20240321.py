...
def tsne_plot(cleantargets, noisytargets, outputs):
    ...
    plt.savefig('plot20240321/tsne_abbl_230330_True.png', bbox_inches='tight')
    # plt.savefig('plot20240321/tsne_pscl_230330_True.png', bbox_inches='tight')
    # plt.savefig('plot20240321/tsne_smp_230330_True.png', bbox_inches='tight')
