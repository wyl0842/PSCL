...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset == 'cub200':
        ...
        train_loader, noisy_label, train_sampler, test_loader, _ = load_cifar10(batch_size=args.batch_size, noise_rate=args.noise_rate, noise_type=args.noise_type,split_per=args.split_percentage, random_seed=args.seed)
