...
def train(dataloader, test_loader, dataloader_test, true_label, noisy_rate):
    ...
    io.savemat('cifar10_asym_ResNet_200epoch60_test_accuracy'+'_'+ str(noisy_rate)+'.mat', mdict={'test_accuracy': epoch_test_accuracy})
...
def main():
    ...
    # for iter in range(rate.size):
        ...
        trainLabel = GN.noisify_asym(nb_classes=args.num_class, dataset='cifar10', train_labels=np.squeeze(trainLabel), noise_type='asymmetric', noise_rate=rate[iter])
