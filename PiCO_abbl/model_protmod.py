...
class PiCO(nn.Module):
    ...
    def __init__(self, args, base_encoder):
        ...
        self.register_buffer("prototypes", torch.zeros(8*args.num_class,args.low_dim))

    @torch.no_grad()
    def prototype_update(self, feat, label):
        # update momentum prototypes
        # 原型更新
        self.prototypes[8*label:8*label+8] = feat
    ...
    def forward(self, img_q, im_k=None, nlabels=None, args=None, eval_only=False):
        ...
        return output, q, features, pseudo_scores, noisy_labels, score_prot
