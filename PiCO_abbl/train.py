...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train(train_loader, model, loss_fn, optimizer, epoch, args, logger, start_upd_prot)
...
def train(train_loader, model, loss_fn, optimizer, epoch, args, tb_logger, start_upd_prot=False):
    ...
    for i, (images_w, images_s, labels, true_labels, index) in enumerate(train_loader):
        ...
        # print(labels.shape)
        cls_out, score_prot = model(X_w, args)
