...
def tsne_plot(cleantargets, noisytargets, outputs):
    ...
    # ax.legend(bbox_to_anchor=(0.5, -0.2), columnspacing=0.2, loc=8, ncol=10, borderpad=0.2, labelspacing=0.2, handlelength=1, handletextpad=0, title='True Label', edgecolor=(0.4, 0.4, 0.4))
    ax.legend(bbox_to_anchor=(0.5, -0.15), columnspacing=0.8, loc=8, ncol=10, borderpad=0.2, labelspacing=0.4, handlelength=1, handletextpad=0, title='True Label', edgecolor=(0.4, 0.4, 0.4))
    ...
    # plt.savefig('plot20240407/tsne_80_231028_True.png', bbox_inches='tight')
    plt.savefig('plot20240407/tsne_moco_231016_True.png', bbox_inches='tight')
