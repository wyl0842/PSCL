# python -u train.py --exp-dir experiment/PiCO-CIFAR-10 --dataset cifar10 --num-class 10 --dist-url 'tcp://localhost:10001' --multiprocessing-distributed --world-size 1 --rank 0 --seed 1 --arch resnet18 --moco_queue 8192 --prot_start 10 --lr 0.01 --wd 1e-3 --cosine --epochs 800 --loss_weight 0.5 --proto_m 0.99 --partial_rate 0.5
# python -u train.py --exp-dir experiment/PSCL1116-CIFAR-100 --dataset cifar100 --num-class 100 --dist-url 'tcp://localhost:10004' --multiprocessing-distributed --world-size 1 --rank 0 --seed 1 --arch resnet18 --moco_queue 8192 --prot_start 800 --lr 0.01 --wd 1e-3 --cosine --epochs 800 --loss_weight 0.5 --proto_m 0.99 --noise_rate 0.4 --noise_type 'symmetric'
# python -u train.py --exp-dir experiment/PSCL230220-CIFAR-10 --dataset cifar10 --num-class 10 --dist-url 'tcp://localhost:10001' --multiprocessing-distributed --world-size 1 --rank 0 --seed 1 --arch resnet18 --moco_queue 8192 --prot_start 20 --lr 0.02 --wd 1e-3 --cosine --epochs 800 --loss_weight 0.5 --proto_m 0.99 --noise_rate 0.4 --noise_type 'symmetric'
# CUDA_VISIBLE_DEVICES=0 python -u train.py --exp-dir experiment/PSCL230220-CIFAR-10 --dataset cifar10 --num-class 10 --dist-url 'tcp://localhost:10001' --multiprocessing-distributed --world-size 1 --rank 0 --seed 1 --arch resnet18 --moco_queue 8192 --prot_start 20 --lr 0.02 --wd 1e-3 --cosine --epochs 800 --loss_weight 0.5 --proto_m 0.99 --noise_rate 0.4 --noise_type 'symmetric'
# python -u train.py --exp-dir experiment/PSCL230228dist-CIFAR-10-preresnet --dataset cifar10 --num-class 10 --dist-url 'tcp://localhost:10001' --multiprocessing-distributed --world-size 1 --rank 0 --seed 1 --arch resnet18 --moco_queue 8192 --prot_start 80 --lr 0.01 --wd 1e-3 --cosine --epochs 800 --loss_weight 0.5 --proto_m 0.99 --noise_rate 0.4 --noise_type 'symmetric'
# CUDA_VISIBLE_DEVICES=0,1 python -u train.py --exp-dir experiment/PSCL230303dist-CIFAR-10-preresnet --dataset cifar10 --num-class 10 --dist-url 'tcp://localhost:10001' --multiprocessing-distributed --world-size 1 --rank 0 --seed 1 --arch resnet18 --moco_queue 8192 --prot_start 100 --lr 0.01 --wd 1e-3 --cosine --epochs 800 --loss_weight 0.5 --proto_m 0.99 --noise_rate 0.4 --noise_type 'symmetric'
# CUDA_VISIBLE_DEVICES=0,1 python -u train.py --exp-dir experiment/PSCL230315-tire --dataset tire --num-class 7 --dist-url 'tcp://localhost:10001' --multiprocessing-distributed --world-size 1 --rank 0 --seed 1 --arch resnet18 --moco_queue 8192 --prot_start 80 --lr 0.01 --wd 1e-3 --cosine --epochs 800 --loss_weight 0.5 --proto_m 0.99 --noise_rate 0.2 --noise_type 'symmetric'
# CUDA_VISIBLE_DEVICES=0,1 python -u train.py --exp-dir experiment/PSCL230315-tire --dataset tire --num-class 7 --dist-url 'tcp://localhost:10001' --multiprocessing-distributed --world-size 1 --rank 0 --seed 1 --arch resnet18 --moco_queue 4096 --prot_start 80 --lr 0.01 --wd 1e-3 --cosine --epochs 800 --loss_weight 0.5 --proto_m 0.99 --noise_rate 0.2 --noise_type 'symmetric'
# CUDA_VISIBLE_DEVICES=1,2 python -u train_correct.py --exp-dir experiment/PSCL230527-tire --dataset tire --num-class 7 --dist-url 'tcp://localhost:10001' --multiprocessing-distributed --world-size 1 --rank 0 --seed 1 --arch resnet18 --moco_queue 8192 --prot_start 160 --lr 0.01 --wd 1e-3 --cosine --epochs 800 --loss_weight 0.1 --proto_m 0.99 --noise_rate 0.2 --noise_type 'symmetric'
# CUDA_VISIBLE_DEVICES=1,2 python -u train_correct.py --exp-dir experiment/PSCL230529-CIFAR-10 --dataset cifar10 --num-class 10 --dist-url 'tcp://localhost:10001' --multiprocessing-distributed --world-size 1 --rank 0 --seed 1 --arch resnet18 --moco_queue 8192 --prot_start 80 --lr 0.01 --wd 1e-3 --cosine --epochs 800 --loss_weight 0.1 --proto_m 0.99 --noise_rate 0.4 --noise_type 'symmetric'
...
# noise parameters
parser.add_argument('--noise_rate', type=float, help='overall corruption rate, should be less than 1', default=0)
parser.add_argument('--noise_type', type=str, help='[pairflip, symmetric, asymmetric]', default='symmetric')
parser.add_argument('--split_percentage', type=float, help='train and validation', default=1)
# parser.add_argument('--num_class', type=int, help='number of classes', default=10)
...
def main():
    ...
    model_path = 'ds_{ds}_nr_{nr}_nt_{nt}_lr_{lr}_ep_{ep}_ps_{ps}_lw_{lw}_pm_{pm}_arch_{arch}_heir_{heir}_sd_{seed}'.format(
                                            ds=args.dataset,
                                            nr=args.noise_rate,
                                            nt=args.noise_type,
                                            lr=args.lr,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset == 'cub200':
        ...
        train_loader, noisy_label, train_sampler, test_loader, original_labels = load_cifar10(batch_size=args.batch_size, noise_rate=args.noise_rate, noise_type=args.noise_type,split_per=args.split_percentage, random_seed=args.seed)
    elif args.dataset == 'cifar100':
        train_loader, noisy_label, train_sampler, test_loader = load_cifar100(batch_size=args.batch_size, noise_rate=args.noise_rate, noise_type=args.noise_type,split_per=args.split_percentage, random_seed=args.seed, num_class=args.num_class)
        ...
        train_loader, noisy_label, train_sampler, test_loader, train_paths = load_tire(batch_size=args.batch_size, noise_rate=args.noise_rate, noise_type=args.noise_type,split_per=args.split_percentage, random_seed=args.seed, num_class=args.num_class)
        # train_loader, train_givenY, train_sampler, test_loader = load_cifar100(partial_rate=args.partial_rate, batch_size=args.batch_size, hierarchical=args.hierarchical)
    else:
    ...
    # # 上两行做了个归一化
    # print(noisy_label)
    confidence = torch.tensor(noisy_label).cuda()
    # print(confidence)
    ...
    # print(noisy_label[0].tolist(), confidence[0].tolist(), train_paths[0])
    # with open(os.path.join(args.exp_dir, 'correction.log'), 'a+') as f:
    #     for i in range(len(noisy_label)):
    #         f.write('{},{},{}\n'.format(noisy_label[i].tolist()
    #             , confidence[i].tolist(), train_paths[i]))

    # print(original_labels[0], noisy_label[0].tolist(), confidence[0].tolist())
    # with open(os.path.join(args.exp_dir, 'correction.log'), 'a+') as f:
    #     for i in range(len(noisy_label)):
    #         f.write('{},{},{}\n'.format(noisy_label[i].tolist()
    #             , confidence[i].tolist(), train_paths[i]))
    ...
    for epoch in range(args.start_epoch, args.epochs):
        is_best = False
        start_upd_prot = epoch>=args.prot_start # 开始原型校正的步骤数
        if args.distributed:
    ...
    with open(os.path.join(args.exp_dir, 'correction.log'), 'a+') as f:
        for i in range(len(noisy_label)):
            if torch.distributed.get_rank() == 0:
                f.write('{};{};{}\n'.format(original_labels[i], noisy_label[i].tolist()
                    , confidence[i].tolist()))
...
def train(train_loader, model, loss_fn, loss_cont_fn, optimizer, epoch, args, tb_logger, start_upd_prot=False):
    ...
    for i, (images_w, images_s, labels, true_labels, index) in enumerate(train_loader):
        ...
        # print(labels.shape)
        cls_out, features_cont, pseudo_score_cont, pseudo_nlabels_cont, score_prot\
            = model(X_w, X_s, labels, args)
        batch_size = cls_out.shape[0]
        # pseudo_target_max返回最大值，pseudo_target_cont最大值的位置（即类别）
        ...
        if start_upd_prot:
            ...
            # mask = None
            nlabels_max, nlabels_cont = torch.max(pseudo_nlabels_cont, dim=1)
            nlabels_cont = nlabels_cont.contiguous().view(-1, 1)
            mask =  torch.eq(nlabels_cont[:batch_size], nlabels_cont.T).float().cuda()
            # Warmup using MoCo
